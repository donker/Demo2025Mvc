...
namespace Bring2mind.Demo2025Mvc.Demo1.Common
{
    ...
    public class Demo1AuthorizeAttribute : AuthorizeAttributeBase, IOverrideDefaultAuthLevel
    {
        private static readonly ILog Logger = LoggerSource.Instance.GetLogger(typeof(Demo1AuthorizeAttribute));
        public SecurityAccessLevel SecurityLevel { get; set; }
        public UserInfo User { get; set; }

        public Demo1AuthorizeAttribute()
        {
            SecurityLevel = SecurityAccessLevel.Admin;
        }

        public Demo1AuthorizeAttribute(SecurityAccessLevel accessLevel)
        {
